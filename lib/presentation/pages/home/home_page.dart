...
import 'package:rakt_pravah/presentation/pages/home/blood_request_screen.dart';
          ...
          child: SingleChildScrollView(
            child: Column(
              children: [
                ...
                const DrawerTile(
                    icon: Icons.person_2_outlined, title: 'My Profile'),
                DrawerTile(
                ...
                const DrawerTile(
                    icon: Icons.reviews_outlined, title: 'Rate Us'),
                DrawerTile(
                  icon: Icons.logout,
                  title: 'Logout',
                  onTap: () {
